...
import { ChefHat, Globe, Hash, Mail, MapPin, Phone } from 'lucide-react';
...
export function CreateRestaurant() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await propertyService.createRestaurant({
        code: formData.code,
        name: formData.name,
      ...
      // Navigate to restaurants list on success
  ...
  return (
    <Box>
      <Group justify="space-between" mb="xl">
        <Stack gap="xs">
          ...
          <Text c="dimmed" size="lg">
            Add a new restaurant property to your management system
          </Text>
        </Stack>
      ...
      >
        <Text size="sm">
          <strong>Note:</strong> All required fields must be filled. Restaurant
